<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu.aspx.cs" Inherits="DebiHotelReservation.menu" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Debi-Menu</title>
</head>
...
<body>
  ...
  <div class="form">
      <h3>Main Menu</h3>
        <br />
      <a href="addImage.aspx"  style="background: #0026ff; padding:17px 98px;  color:white" >Add Image</a>
        <br />
        <br />
        <br />
     <a href="addRoom.aspx"  style="background: #0026ff; padding:17px 99px;  color:white" >Add Room</a>
       <br />
       <br />
       <br />
    <a href="manageRoom.aspx"  style="background: #0026ff; padding:17px 85px;  color:white" >Manage Room</a>
