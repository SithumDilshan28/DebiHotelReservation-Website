<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reservation.aspx.cs" Inherits="DebiHotelReservation.reservation" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Debi-Reservation</title>
...
<!-- START: header -->
  ...
  <div class="form">
      ...
      <asp:Button style="background: #0026ff; height:50px; color:white" ID="Button1" runat="server" Text="Check Availability" OnClick="Button1_Click" />
   </div>
          ...
          <section class="grid">
       <asp:GridView ID="GridView1"  CssClass="paging" PageSize="10" runat="server" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="100px" Width="1400px" BackColor="White" BorderColor="#E7E7FF" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
