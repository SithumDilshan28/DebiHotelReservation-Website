<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="DebiHotelReservation.signuo" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Debi-Signup</title>
...
<!-- START: header -->
  ...
  <div class="form">
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="Textbox6" CssClass="styletext" ErrorMessage="Empty Field"></asp:RequiredFieldValidator>
        <asp:Button style="background: #0026ff; height:50px; color:white" ID="Button1" runat="server" Text="Create" OnClick="Button1_Click" />
